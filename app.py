...
# ============================================================
# GESTIÓN DE PROVEEDORES (CON CEREBRAS PRIORIDAD 1)
# ============================================================
        ...
        if api_key:
            if provider == 'cerebras':
                providers[provider] = {
                    ...
                    "model": config.get(f"{provider}_model", "llama4-scout-8b-16b-instruct"),
                ...
                providers[provider] = {
                    ...
                    "priority": int(config.get(f"{provider}_priority", 7))
                }
    return providers
...
def configurar_proveedor():
    ...
    if provider not in ['cerebras', 'gemini', 'deepseek', 'openai', 'anthropic', 'groq', 'openrouter']:
...
if __name__ == "__main__":
    print("🚀 Iniciando Aether v5.2 (con validación de BD y aprendizaje libre desactivado)", file=sys.stderr)
